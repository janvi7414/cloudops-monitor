# to get the latest ami id of rhel 9 in specified region always
data "aws_ami" "rhel" {
  most_recent = true
...
resource "aws_security_group" "k8s_sg" {
  ...
  # Allow all internal cluster traffic between members
  ingress {
    from_port = 0
    to_port   = 0
    protocol  = "-1"
  ...
  # Allow React Application NodePort Access
  ingress {
    from_port   = 30001
    to_port     = 30001
    protocol    = "tcp"
